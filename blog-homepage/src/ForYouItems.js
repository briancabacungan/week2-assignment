...
class ForYouItems extends Component {
    ...
    render() {
        const articleItems = this.props.articles.map((article) => {
            ...
            let audioAndMember = "";
            if (article.AudioAvailable && article.memberPreview) {
                audioAndMember = <p> Audio available and Member preview</p>;
            } else if (article.AudioAvailable) {
            ...
            return (
                <div className="forYouSection">
                    ...
                    <div className="ForYourArticleDetail">
                        {audioAndMember}
                        <a href={article.link}
                            ><h2>{article.title}</h2>
                        </a>
                        ...
                        <div className="ForYouAuthorInfo">
        ...
        return <div className="ForYouArticles">{articleItems}</div>;
    }
}
